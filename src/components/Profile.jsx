        ...
        <div className="ml-[100px] md:ml-[200px] lg:ml-[220px] flex md:justify-center items-center h-screen py-4 md:py-0 md:h-[600px]">
            <div className="contain flex w-full lg:w-[55%] flex-col md:flex-row justify-between items-center h-full md:h-[70%] gap-8 lg:gap-16">
                <div className="flex flex-col items-center left-pro md:w-[40%]">
                    <div className="pic rounded-full border relative w-[200px] lg:w-[300px] h-[200px] lg:h-[300px] overflow-hidden "><input onChange={handleChange} className="pic-upload absolute top-0 left-0 h-full w-full opacity-0 cursor-pointer" type="file" name="profile" id="propic" /><img className="w-[300px] h-[300px] object-cover cursor-pointer" src={propic} alt="user profile"/></div>
